...
module NcsNavigator::StaffPortal::Warehouse::ThreePointTwo
  describe 'Enumerator', :clean_with_truncation, :slow, :warehouse do
    ...
    shared_context 'mapping test 3.2' do
      before do
    ...
    shared_examples 'one-to-one valid 3.2' do
    ...
    shared_examples 'staff associated 3.2' do
    ...
    describe 'for Staff' do
      ...
      include_examples 'one-to-one valid 3.2'

      context do
        include_context 'mapping test 3.2'
    ...
    describe 'for StaffLanguage' do
      ...
      context 'from code list' do
        ...
        include_examples 'staff associated 3.2'
        include_examples 'one-to-one valid 3.2'
      end
    ...
    describe 'staff weekly expenses' do
      ...
      context do
        include_examples 'mapping test 3.2'
      ...
      shared_examples 'summed attributes 3.2' do
        include_context 'mapping test 3.2'
      ...
      describe 'with management tasks' do
        ...
        include_examples 'summed attributes 3.2'
      end
    ...
    describe 'for OutreachEvent' do
      ...
      shared_examples 'a basic outreach event 3.2' do
        include_context 'mapping test 3.2'
      ...
      describe 'when tailored' do
        ...
        it_behaves_like 'a basic outreach event 3.2'

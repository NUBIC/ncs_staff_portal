...
module NcsNavigator::StaffPortal::Warehouse::ThreePointZero
  describe 'Enumerator', :clean_with_truncation, :slow, :warehouse do
    ...
    shared_context 'mapping test 3.0' do
      before do
    ...
    shared_examples 'one-to-one valid 3.0' do
    ...
    shared_examples 'staff associated 3.0' do
    ...
    describe 'for Staff' do
      ...
      include_examples 'one-to-one valid 3.0'

      context do
        include_context 'mapping test 3.0'
    ...
    describe 'for StaffLanguage' do
      ...
      context 'from code list' do
        ...
        include_examples 'staff associated 3.0'
        include_examples 'one-to-one valid 3.0'
      end
    ...
    describe 'staff weekly expenses' do
      ...
      context do
        include_examples 'mapping test 3.0'
      ...
      shared_examples 'summed attributes 3.0' do
        include_context 'mapping test 3.0'
      ...
      describe 'with management tasks' do
        ...
        include_examples 'summed attributes 3.0'
      end
    ...
    describe 'for OutreachEvent' do
      ...
      let!(:outreach_event) {
        Factory(:outreach_event)
      }

      shared_examples 'a basic outreach event 3.0' do
        include_context 'mapping test 3.0'
        ...
        it 'includes ssu_id as nil as PBS Outreach event has no any ssu associated' do
         results.first.ssu_id.should be_nil
        end
        
        it 'includes tsu_id as nil as PBS Outreach event has no any tsu associated' do
         results.first.tsu_id.should be_nil
        end
      end
      ...
      describe 'when tailored' do
        ...
        it_behaves_like 'a basic outreach event 3.0'

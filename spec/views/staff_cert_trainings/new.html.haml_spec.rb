...
describe "staff_cert_trainings/new.html.haml" do
  before(:each) do
    assign(:staff_cert_training, stub_model(StaffCertTraining,
  ...
  it "renders new staff_cert_training form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => staff_cert_trainings_path, :method => "post" do
